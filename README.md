...
- Five normal enemy behaviors plus a final boss or fallback final elite wave
...
- [x] Blood Fan, Winger, Defender, Coach, and airborne Bat Swarm archetypes with escalating spawn weights
