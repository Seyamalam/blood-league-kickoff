...
import { EVOLUTION_DEFINITIONS, type EvolutionUnlockEvent } from '../game/progression';
...
describe('createEvolutionToastView', () => {
  it.each(['moonBreaker', 'crimsonMeteor'] as const)(
    'maps %s to its visible copy and unique icon',
    (evolutionId) => {
