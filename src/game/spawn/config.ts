...
export const FULL_MATCH_SPAWN_CONFIG: SpawnDirectorConfig = Object.freeze({
  ...
  firstHalf: Object.freeze({
    ...
    roster: roster([
      ...
      { archetype: 'bloodArcher', weight: 4, unlockMatchTime: 72 },
      { archetype: 'shadowRunner', weight: 3, unlockMatchTime: 82 },
  ...
  escalation: Object.freeze({
    ...
    roster: roster([
      ...
      { archetype: 'bloodArcher', weight: 7, unlockMatchTime: 72 },
      { archetype: 'shadowRunner', weight: 6, unlockMatchTime: 82 },
      { archetype: 'corpseBomber', weight: 5, unlockMatchTime: 170 },
  ...
  bloodMoon: Object.freeze({
    ...
    roster: roster([
      ...
      { archetype: 'bloodArcher', weight: 8 },
      { archetype: 'shadowRunner', weight: 7 },
      { archetype: 'corpseBomber', weight: 7 },
  ...
  finalWave: Object.freeze({
    ...
    roster: roster([
      ...
      { archetype: 'leechStriker', weight: 10 },
      { archetype: 'bloodArcher', weight: 8 },
      { archetype: 'shadowRunner', weight: 8 },
      { archetype: 'corpseBomber', weight: 8 },
      { archetype: 'corruptReferee', weight: 7 },
