...
| Procedural visuals, UI, and audio systems | Huntrix | TypeScript, Three.js, CSS, Web Audio   | 2026-07-14 onward | Generated at runtime from project source; complements the recorded soundtrack and CC0 UI samples listed below                          |
...
| `public/assets/audio/music/blood-league-menu.mp3`  | Google Gemini / Lyria 3                 | `docs/art/AUDIO_GENERATION_RECORD.md`    | 2026-07-20 | Downloaded as MP3; renamed only                                       | Team-directed original instrumental; no vocals, quoted melody, logo, or real-player reference             |
| `public/assets/audio/music/blood-league-match.mp3` | Google Gemini / Lyria 3                 | `docs/art/AUDIO_GENERATION_RECORD.md`    | 2026-07-20 | Downloaded as MP3; renamed only                                       | Team-directed original instrumental for standard play                                                     |
| `public/assets/audio/music/blood-league-boss.mp3`  | Google Gemini / Lyria 3                 | `docs/art/AUDIO_GENERATION_RECORD.md`    | 2026-07-20 | Downloaded as MP3; renamed only                                       | Team-directed original instrumental for the final wave                                                    |
...
| Asset/path                     | Title           | Author | Source URL                                               | License                       | Modifications                                                    |
| ------------------------------ | --------------- | ------ | -------------------------------------------------------- | ----------------------------- | ---------------------------------------------------------------- |
| `public/assets/audio/ui/*.ogg` | Kenney UI Audio | Kenney | [Official asset page](https://kenney.nl/assets/ui-audio) | CC0 1.0; bundled license text | Seven selected files renamed by UI role; audio content unchanged |

The three soundtrack files were generated in the team's authenticated Gemini session using prompts requesting original instrumental music without existing melodies or vocals. Gemini's [music-generation help](https://support.google.com/gemini/answer/16901237?hl=en-GA) documents MP3 export and embedded SynthID watermarking. These tracks are recorded as team-directed AI-generated assets, not as open-source or CC0 material.
