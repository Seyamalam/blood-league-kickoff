...
| Procedural player humanoid                | Huntrix | TypeScript and Three.js                | 2026-07-14        | Original runtime-authored model and animation; no real-player likeness, imported model, or AI-generated 3D asset; production GLB acceptance contract documented in `CHARACTER_ASSET_PIPELINE.md` |
...
| `docs/screenshots/*.jpg`                  | Huntrix | Chromium capture and FFmpeg            | 2026-07-14        | Twenty-one direct game captures at documented historical/current dimensions; title captures composite the generated key art recorded below                                                       |
