...
- The repository contains three authored JPEG screenshots.
- No generated raster image, imported 3D model, texture, audio recording, bundled font, or third-party player-facing asset is currently present.
...
| Category                                                                      | Source                                | Tool                                   | License/ownership                         | Changes/current state                                                                                                                        |
| ----------------------------------------------------------------------------- | ------------------------------------- | -------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| HUD, title screen, pause, halftime, upgrades, tutorial, settings, and results | `src/ui/`, `src/styles.css`           | TypeScript, HTML DOM, CSS              | Project-created code                      | Layout, typography, gradients, borders, icons/glyphs, animation, and reduced-motion behavior are authored directly; no raster UI kit is used |
...
All current screenshots are direct captures of the running game and therefore depict the procedural visuals and authored interface listed above. No AI image generator or third-party image source was used for these repository files.

| Path                                | Source                           | Tool                                  | License/ownership       | Changes/current state                                                                                                                      |
| ----------------------------------- | -------------------------------- | ------------------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `docs/screenshots/title-screen.jpg` | Running local game title screen  | Local browser capture; JPEG, 1280×720 | Project-created capture | README title image; repository file is the source of record; SHA-256 `64820abc388a35438e280db846c637a56a2470e9a095f11fd9ee899939fb2a1f`    |
...
| ----------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AI-generated raster images                            | _None_        | Do not list a planned image as created. When one is added, record its repository path, generator/model, prompt or brief location, generation date, human edits, and redistribution status. |
